 ...
 const fetchFacultyList=()=>{
    ...
    const PostSubjectAllocation =async ()=>{
      if(facultyID==='' || courseCode===''){
          alert('please select faculty id and course code');
          return;
      }
        ...
        <Modal.Body>
          <form>
              <div className="row container-fluid p-3">
                <select required className="col-sm-3" value={courseCode} onChange={ e => setCourseCode(e.target.value)}>
                ...
                <select required className="col-sm-3" name="facultyID" value={facultyID} onChange={ e => setFacultyID(e.target.value)}>
                ...
                <div className="col-sm-1"></div>
                <select className="col-sm-3" value={section} onChange={ e => setSection(e.target.value)}>
